...
//	
//	crollno=new Choice();
//	crollno.setBounds(60,130,220,20);
//	add(crollno);
//	try {
//		Conn c=new Conn();
...
public class StudentLeave extends JFrame implements ActionListener {
    ...
    private final Color BACKGROUND_COLOR = new Color(230, 240, 250);
    ...
    StudentLeave() {
        ...
        lblrollno.setBounds(50, 100, 400, 25);
        lblrollno.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        mainPanel.add(lblrollno);
        
        crollno = new Choice();
        crollno.setBounds(50, 130, 400, 30);
        crollno.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        mainPanel.add(crollno);
